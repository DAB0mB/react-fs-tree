...
let FSNode = (_temp = _class = class FSNode extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  constructor(props) {
    ...
    this._getDepthSize = () => {
      const padding = 36;
      //return padding;
      // // console.log((Boolean(this.props.node.childNodes.length) && `${padding}px`) || `${padding + 14}px`)
      // console.log(this._path, this.props.hasChildNodes, (this.props.hasChildNodes && `${padding}px`) || `${padding + 14}px`)
      // debugger; 
    ...
    this._getIcon = () => {
      ...
      if (!this.props.node.childNodes) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
          'span',
          null,
          react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(IconType, null)
        );
      }
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
        'span',
      ...
      react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
          ...
          react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
              'div',
              { className: 'FSNode-descriptor-container' },
              react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(
                'div',
